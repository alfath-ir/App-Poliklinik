                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Data User Poliklinik</h5>
                                                        <a href="<?= base_url('user/tambah_user'); ?>" class="btn btn-sm btn-primary  m-r-10 float-right">Tambah User</a>
                                                            ...
                                                            <table id="order-table" class="table table-striped table-bordered nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="200px" class="text-center">Profesi</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($dataUser as $d) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="m-l-20"><?= $d['nama']; ?></td>
                                                                            <td class="text-center"><?= $d['tugas']; ?></td>
                                                                            <td class="text-center">
                                                                                <a href="<?= base_url('user/edit_user/') . $d['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Edit" class="text btn waves-effect waves-light btn-warning btn-sm"><i class="feather icon-edit"></i></a>
                                                                                <!--  -->
                                                                                <a href="<?= base_url('user/detail_user/') . $d['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Detail" class="text btn waves-effect waves-light btn-primary btn-sm"><i class="feather icon-info"></i></a>
                                                                                <!--  -->
                                                                                <a href="<?= base_url('user/hapus_user/') . $d['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Hapus" class="text btn waves-effect waves-light btn-danger btn-sm"><i class="feather icon-trash-2"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php endforeach; ?>
