                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Data Pasien Karyawan Poliklinik</h5>
                                                        <a href="<?= base_url('pasien'); ?>" class="btn btn-sm btn-warning  m-r-10 float-right">Pasien Mahasiswa</a>
                                                                    ...
                                                                    <?php foreach ($pasien as $p) : ?>
                                                                        <tr class="border-bottom-primary">
                                                                            ...
                                                                            <td class="text-center">
                                                                                ...
                                                                                <!--  -->
                                                                                <a href="<?= base_url('pasien/hapuskaryawan/') . $p['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Hapus" class="text btn waves-effect waves-light btn-danger btn-sm"><i class="feather icon-trash-2"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php endforeach; ?>
