                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Data Pasien Mahasiswa Poliklinik</h5>
                                                        <a href="<?= base_url('pasien/karyawan'); ?>" class="btn btn-sm btn-warning  m-r-10 float-right">Pasien Karyawan</a>
                                                        <a href="<?= base_url('pasien/tambah'); ?>" class="btn btn-sm btn-success  m-r-10 float-right">Pasien Baru</a>
                                                    </div>
                                                            ...
                                                            <table id="order-table" class="table table-striped table-bordered nowrap">
                                                                <thead>
                                                                    <tr class="bordzer-bottom-danger">
                                                                        ...
                                                                        <th width="200px" class="text-center">Usia</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($pasien as $p) : ?>
                                                                        <tr class="border-bottom-primary">
                                                                            ...
                                                                            <td class="m-l-20"><?= $p['nama']; ?></td>
                                                                            <td class="text-center"><?= timespan(strtotime($p['tgl_lahir']), $today, 1); ?></td>
                                                                            <td class="text-center">
                                                                                <a href="<?= base_url('pasien/edit/') . $p['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Edit" class="text btn waves-effect waves-light btn-warning btn-sm"><i class="feather icon-edit"></i></a>
                                                                                <!--  -->
                                                                                <a href="<?= base_url('pasien/detail/') . $p['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Detail" class="text btn waves-effect waves-light btn-primary btn-sm"><i class="feather icon-info"></i></a>
                                                                                <!--  -->
                                                                                <a href="<?= base_url('pasien/hapus/') . $p['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Hapus" class="text btn waves-effect waves-light btn-danger btn-sm"><i class="feather icon-trash-2"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php endforeach; ?>
