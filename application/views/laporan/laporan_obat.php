                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <a href="<?= base_url('laporan'); ?>" class="btn waves-effect waves-light btn-primary btn-primary btn-block">Obat</a>
                                                            </div>
                                                            <div class="col-3">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <a href="<?= base_url('laporan/print_obat'); ?>" class="btn btn-success btn-sm  m-r-10 float-right">Print</a>
                                                    </div>
                                                    <div class="card-block">
