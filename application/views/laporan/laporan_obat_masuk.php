                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3">
                                                                <a href="<?= base_url('laporan/obat_masuk'); ?>" class="btn waves-effect waves-light btn-primary btn-block">Obat Masuk</a>
                                                            </div>
                                                            <div class="col-3">
                                                                <a href="<?= base_url('laporan/obat_keluar'); ?>" class="btn waves-effect waves-light btn-primary btn-outline-primary btn-block">Obat Keluar</a>
                                                            </div>
                                                            <div class="col-3">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Data Obat Masuk Poliklinik</h5>
                                                        <a href="<?= base_url('laporan/print_om'); ?>" class="btn btn-success btn-sm  m-r-10 float-right">Print</a>
                                                    </div>
                                                    <div class="card-block">
