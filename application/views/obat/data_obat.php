                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Data Obat Poliklinik</h5>
                                                        <a href="<?= base_url('obat/obat_baru'); ?>" class="btn btn-sm btn-primary  m-r-10 float-right">Tambah Obat Baru</a>
                                                        <a href="<?= base_url('obat/obat_lama'); ?>" class="btn btn-sm btn-success  m-r-10 float-right">Obat Masuk</a>
                                                        <a href="<?= base_url('obat/obat_keluar'); ?>" class="btn btn-sm btn-success  m-r-10 float-right">Obat Keluar</a>
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($dataObat as $d) : ?>
                                                                        <tr class="border-bottom-primary">
                                                                            ...
                                                                            <td class="m-l-20"><?= $d['nm_obat']; ?></td>
                                                                            <td class="text-center"><?= $d['stok']; ?></td>
                                                                            <td class="text-center">
                                                                                <a href="<?= base_url('obat/edit_obat/') . $d['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Edit" class="text btn waves-effect waves-light btn-warning btn-sm"><i class="feather icon-edit"></i></a>
                                                                                <!--  -->
                                                                                <a href="<?= base_url('obat/hapus_obat/') . $d['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Hapus" class="text btn waves-effect waves-light btn-danger btn-sm"><i class="feather icon-trash-2"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php endforeach; ?>
