                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Form Obat Masuk</h5>
                                                    </div>
                                                    <div class="card-block">

                                                        <form method="POST" action="<?= base_url('obat/updateObat'); ?>">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-5">
                                                                    <input type="number" name="jumlah" id="jumlah" placeholder="Jumlah Pcs/Botol" class="form-control">
                                                                    <?= form_error('jumlah', '<small class="text-danger pl-2">', '</small>'); ?>
                                                                </div>
                                                            </div>
                                                    </div>
                                                    <div>
                                                        <button type="submit" class="btn btn-success btn-sm m-b-20 m-r-35 float-right">Simpan</button>
                                                        <a href="<?= base_url('obat'); ?>" class="btn btn-secondary btn-sm m-b-30 m-r-10 float-right">Kembali</a>
                                                    </div>
                                                    </form>
                                                </div>
                                            </div>
                                                            ...
                                                            <table id="order-table" class="table table-striped table-bordered nowrap">
                                                                <thead>
                                                                    <tr class="bordzer-bottom-danger">
                                                                        ...
                                                                        <th width="200px" class="text-center">Satuan</th>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php foreach ($obat_masuk as $om) : ?>
                                                                        <tr class="border-bottom-primary">
                                                                            ...
                                                                            <td class="m-l-20"><?= $om['nm_obat']; ?></td>
                                                                            <td class="text-center"><?= $om['jumlah']; ?></td>
                                                                            <td class="text-center"><?= $om['jenis']; ?></td>
                                                                            <td class="text-center"><?= $om['tgl']; ?></td>
                                                                            <td class="text-center">
                                                                                <a href="<?= base_url('obat/hapus_masuk/') . $om['id']; ?>" data-toggle="tooltip" data-trigger="hover" data-placement="bottom" data-original-title="Hapus" class="text btn waves-effect waves-light btn-danger btn-sm"><i class="feather icon-trash-2"></i></a>
                                                                            </td>
                                                                        </tr>
                                                                        <?php $i++; ?>
                                                                    <?php endforeach; ?>
