                                                        ...
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        <h6 class="font-weight-bold">Kunjungan Hari Ini</h6>
                                                                        <h3 class="f-w-700 text-c-blue"><?= $nowPeriksa; ?></h3>
                                                                    </div>
                                                                    <div class="col-auto m-r-30">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        <h6 class=" font-weight-bold">Kunjungan Bulan Ini</h6>
                                                                        <h3 class="f-w-700 text-c-green"><?= $monthPeriksa; ?></h3>
                                                                    </div>
                                                                    <div class="col-auto col-auto m-r-30">
                                                                        <i class="fas fa-users"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-4">
                                                        <div class="card comp-card">
                                                            <div class="card-body">
                                                                <div class="row align-items-center">
                                                                    <div class="col">
                                                                        <h6 class="font-weight-bold">Kunjungan Bulan lalu</h6>
                                                                        <h3 class="f-w-700 text-c-yellow"><?= $prevPeriksa; ?></h3>
                                                                    </div>
                                                                    <div class="col-auto m-r-30">
                                                                        <i class="fas fa-users"></i>
                                                                    </div>
                                                            ...
                                                            <table id="scr-vrt-dt" class="table table-bordered nowrap">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="200px" class="text-center">Tipe Pasien</th>
                                                                        <th width="200px" class="text-center">Tanggal</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <?php $i = 1; ?>
                                                                    <?php foreach ($lastPeriksa as $p) : ?>
                                                                        <?php
                                                                        $id = $p['id_pasien'];

                                                                        $query = "SELECT * FROM `periksa`
                                                                        JOIN `pasien` ON `periksa`.`id_pasien` = `pasien`.`id` WHERE `id_pasien` = $id";

                                                                        $pasien = $this->db->query($query)->row_array();
                                                                        ?>
                                                                        <tr>
                                                                            <td class="text-center"><?= $i; ?></td>
                                                                            <td><?= $pasien['nama']; ?></td>
                                                                            <td class="text-center"><?php
                                                                                                    if ($pasien['tipe_pasien'] == 1) {
                                                                                                        echo 'Karyawan';
