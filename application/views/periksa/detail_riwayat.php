                                                    ...
                                                    <div class="card-block">
                                                        <div class="form-group row">
                                                            <div class="col-4">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="td" id="td" class="form-control" value="<?= $periksa['tekanan_darah']; ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <label class="col-sm-12 col-form-label">Gula Darah</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="gd" id="gd" class="form-control" value="<?= $periksa['gula_darah']; ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <label class="col-sm-6 col-form-label">Asam Urat</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="au" id="au" class="form-control" value="<?= $periksa['asam_urat']; ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <a href="<?= base_url('periksa'); ?>" class="btn btn-secondary btn-sm m-b-30 m-r-30 float-right">Kembali</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="form-group row">
                                                            <div class="col-6">
                                                                <label class="col-sm-12 col-form-label">Diagnosa</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="td" id="td" class="form-control" value="<?= $diagnosa['diagnosa']; ?>" disabled>
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <label class="col-sm-12 col-form-label">Gula Darah</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="gd" id="gd" class="form-control" value="<?= $diagnosa['tanggal']; ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="dt-responsive table-responsive">
                                                                    <table id="order-table" class="table table-striped table-bordered nowrap">
                                                                        ...
                                                                        <tbody>
                                                                            <?php $i = 1; ?>
                                                                            <?php foreach ($obat_pasien as $op) : ?>
                                                                                <?php
                                                                                $data = $this->db->get_where('tb_obat', ['id' => $op['id_obat']])->row_array();
                                                                                ?>
                                                                                <tr class="border-bottom-primary">
                                                                                    <th class="text-center"><?= $i; ?></th>
                                                                                    <td class="m-l-20"><?= $data['nm_obat']; ?></td>
