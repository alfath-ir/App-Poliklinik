                                            ...
                                            <div class="col-sm-8">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        <form action="<?= base_url('periksa/tambahDiagnosa'); ?>" method="POST">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="input-group input-group-button">
                                                                            <input type="text" name="diagnosa" id="diagnosa" class="form-control" autocomplete="off" autofocus>
                                                                            <div class="input-group-append">
                                                                                <button type="submit" class="btn btn-success btn-sm" type="button">Tambah</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-12 mb-1">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="no" id="no" class="form-control" value="<?= date('Y-m-d'); ?>" disabled>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
