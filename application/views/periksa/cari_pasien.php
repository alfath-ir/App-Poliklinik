                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <a href="<?= base_url('pasien/tambah'); ?>" class="btn btn-sm btn-success float-right">Pasien Baru</a>
                                                        <div class="float-right m-r-20">
                                                            <span><i class="text-danger">*</i>Jika pasien tidak ada, tambah pasien baru terlebih dahulu</span>
                                                        </div>
                                                    </div>
                                                    <div class="card-block">
                                                        <form method="POST" action="">
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    <input type="text" name="keyword" placeholder="Nama Pasien" class="form-control">
                                                                    <button type="submit" class="btn btn-primary btn-sm btn-block mt-2">Cari</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                            ...
                                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th width="300px" class="text-center">Umur</th>
                                                                    ...
                                                                    <?php foreach ($pasien as $p) : ?>
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                <a href="<?= base_url('periksa/cek/' . $p['id']); ?>" class="btn btn-sm btn-warning ">Periksa</a>
                                                                                <a href="<?= base_url('periksa/riwayat/' . $p['id']); ?>" class="btn btn-sm btn-primary ">Riwayat Penyakit</a>
                                                                            </td>
                                                                        </tr>
                                                                    <?php endforeach; ?>
                                                                    <?php $i++; ?>
